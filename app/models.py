...
class rol(models.Model):
    rol_id = models.IntegerField(auto_created=True, primary_key=True)
    tipo = models.CharField(max_length=50, null=False)

class empresa(models.Model):
    empresa_id=models.IntegerField(auto_created=True, primary_key=True)
...
class estado_financiero(models.Model):
    estado_financiero_id=models.IntegerField(auto_created=True, primary_key=True)
    estado=models.IntegerField(null=False)
    cantidad=models.IntegerField(null=False)

class usuario(models.Model):
    usuario_id = models.IntegerField(auto_created=True, primary_key= True)
    nombre = models.CharField(max_length= 50, null=False)
...
class empleado(models.Model):
    empleado_id= models.IntegerField(auto_created=True, primary_key=True)
    empresa_id= models.ForeignKey(empresa,on_delete=models.CASCADE)
